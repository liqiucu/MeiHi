...
namespace MeiHi.CommonDll.Helper
{
    public class Utils
    {
        ...
        public static void HistoryRestore(string cookieName, long objectID)
        {
            ...
            if (Request.Cookies[cookieName] != null)
            {
                ...
                tempCurBuyerList.Domain = ConfigurationManager.AppSettings["CookieDomain"];
                //tempCurBuyerList.Domain
            ...
            else
            {
                ...
                addToCookies.Domain = ConfigurationManager.AppSettings["CookieDomain"];
